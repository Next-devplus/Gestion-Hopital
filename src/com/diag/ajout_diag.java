...
/**
 * Servlet implementation class ajout_diag
 */
@WebServlet("/ajout_diag")
public class ajout_diag extends HttpServlet {
	...
	//----------------------------------------------------------------------------------
	String q1 = "INSERT INTO `diag`(`description`)   VALUES ('" +specialite+ "')";
