...
/**
 * Servlet implementation class ajout_sec
 */
@WebServlet("/ajout_sec")
public class ajout_sec extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher dispatcher = null; 
	  	  ...
	  	  try {
	  		...
	  		String q1=" INSERT INTO `sect`(`nom`, `service`, `email`, `contact`,`login`, `pwd`, `role`) values('"+a+"','"+service+"','"+c+"','"+d+"','"+e+"','"+f+"','4')";
