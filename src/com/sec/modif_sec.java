...
/**
 * Servlet implementation class modif_sec
 */
@WebServlet("/modif_sec")
public class modif_sec extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher dispatcher = null; 
	  	  ...
	  	  try {
	  		...
	  		String q1=" UPDATE `sect` SET `nom`='"+a+"',`service`='"+service+"',`email`='"+c+"',`contact`='"+d+"',`login`='"+e+"',`pwd`='"+f+"',`role`='4' WHERE id='"+id+"'";
	  		System.out.println(q1);
	st.executeUpdate(q1);
	 //System.out.println(q1);
	//-----------------------------------------------------------------------------------
	  	                       dispatcher = request.getRequestDispatcher("/admin_sect.jsp"); 
