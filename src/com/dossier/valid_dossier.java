...
/**
 * Servlet implementation class valid_dossier
 */
@WebServlet("/valid_dossier")
public class valid_dossier extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public valid_dossier() {
        super();
		...
		RequestDispatcher dispatcher = null; 
	  	  ...
	  	  try {
	  		...
	  		Statement st=con.createStatement();
	  	                   ...
	  	                   Date date = new Date();
 	//----------------------------------------------------------------------------------
	String q1 = "UPDATE `doss_patient` SET `date_validation`='"+date+"' where  id='" +id+ "'";
