...
/**
 * Servlet implementation class ajout_service
 */
@WebServlet("/ajout_service")
public class ajout_service extends HttpServlet {
	...
	//----------------------------------------------------------------------------------
	String q1 = "INSERT INTO `service`(`description`)   VALUES ('" +specialite+ "')";
