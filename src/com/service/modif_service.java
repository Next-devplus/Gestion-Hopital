...
/**
 * Servlet implementation class modif_service
 */
@WebServlet("/modif_service")
public class modif_service extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public modif_service() {
        super();
	...
	//----------------------------------------------------------------------------------
	  	                     String q1="UPDATE `service` SET `description`= '" +specialite+ "' where id='" +id+ "'";
