...
/**
 * Servlet implementation class sup_admission
 */
@WebServlet("/sup_admission")
public class sup_admission extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public sup_admission() {
        super();
	...
	//----------------------------------------------------------------------------------
	String q1 = "Delete  from  `admission` where  id='" +id+ "'";
