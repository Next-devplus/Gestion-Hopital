...
/**
 * Servlet implementation class Sup_specialite
 */
@WebServlet("/Sup_specialite")
public class Sup_specialite extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sup_specialite() {
        super();
	...
	//----------------------------------------------------------------------------------
	String q1 = "Delete  from  `specilite_list` where  id='" +specialite+ "'";
