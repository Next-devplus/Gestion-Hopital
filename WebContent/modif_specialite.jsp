      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="#">   Modification Spécialité </a>
          </li>
        ...
        <div id="content">
			...
			<form id="form1" name="form1" method="get" action="/Gestion_Hopital/modif_specialite">
      ...
      <tr>
        ...
        <td><span class="style2"><strong>
          <label>          </label>
            ...
            <input name="Submit" type="submit"   value="Modifier Spécialié"  class="btn btn-primary"/>
          </strong></div>
        </label></td>
      </tr>
    </table>
