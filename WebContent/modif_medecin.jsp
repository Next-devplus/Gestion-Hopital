  <%@ include file = "menu.jsp" %>
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div id="content">
			...
			<form id="form1" name="form1" method="get" action="/Gestion_Hopital/modif_medecin">
    ...
    <table width="730" height="244" border="0">
      ...
      <tr>
        <td><div align="left" class="style2"><strong>Specialite: </strong></div></td>
        <td>
          <div align="left" class="style2"><strong>
             ...
             <option class="username" value="-1"> Specialite</option>
             	    <%
...
String query="select * from specilite_list";
...
<tr>
          <td><div align="left" class="style11"><strong>Role : </strong></div></td>
          <td><div align="left" class="style11"><strong>
      ...
      <tr>
        ...
        <td><span class="style2"><strong>
          <label>          </label>
            ...
            <input name="Submit" type="submit"   value="Modifier Medecin"  class="btn btn-primary"/>
          </strong></div>
        </label></td>
      </tr>
    </table>
