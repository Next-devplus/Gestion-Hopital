 <%@ include file = "menudoc.jsp" %>
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="#">   Ajout Resumé De Sortie </a>
          </li>
        ...
        <div id="content">
			...
			<form id="form1" name="form1" method="get" action="/Gestion_Hopital/ajout_resume">
    <table width="730" height="244" border="0">
       ...
       <tr>
        <td><div align="left" class="style2"><strong>Resumé: </strong></div></td>
        <td>
      ...
      <tr>
        ...
        <td><span class="style2"><strong>
          <label>          </label>
            ...
            <input name="Submit" type="submit"   value="Ajouter Résumé"  class="btn btn-primary"/>
          </strong></div>
        </label></td>
      </tr>
    </table>
