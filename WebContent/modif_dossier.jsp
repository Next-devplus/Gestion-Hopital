    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div id="content">
			...
			<form id="form1" name="form1" method="get" action="/Gestion_Hopital/modif_dossier">
...
%>
	...
	<tr>
        ...
        <td>
          <div align="left" class="style2"><strong>
            <input name="textfield4" type="text" class="form-control" id="textfield4"  value=" <% String desc=request.getParameter("desc");
                          out.print(desc);
	   	...
	   	<tr>
        <td><div align="left" class="style2"><strong>Resumé Sortie: </strong></div></td>
        <td>
          <div align="left" class="style2"><strong>
            <input name="r_sec" type="text" class="form-control" id="r_sec"   required="required"/>
            </strong></div></td>
      </tr>
      ...
      <tr>
        ...
        <td><span class="style2"><strong>
          <label>          </label>
            ...
            <input name="Submit" type="submit"   value="Modifier Dossier Patient"  class="btn btn-primary"/>
          </strong></div>
        </label></td>
      </tr>
    </table>
