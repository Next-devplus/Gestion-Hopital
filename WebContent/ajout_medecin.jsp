    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div id="content">
			...
			<form id="form1" name="form1" method="get" action="/Gestion_Hopital/ajout_medecin">
      ...
      <tr>
        ...
        <td><span class="style2"><strong>
          <label>          </label>
            ...
            <input name="Submit" type="submit"   value="Ajouter Medecin"  class="btn btn-primary"/>
          </strong></div>
        </label></td>
      </tr>
    </table>
